(defproject hi "0.0.1-SNAPSHOT" ; "SNAPSHOT" is a maven term; it means "development version", and is contrasted with "release"
  ...
  :npm { ;; package.json npm dependencies
         ...
         :package      { :name "hi"
                         ...
                         :bin "target/hi.js" ; we target the cljsbuild :main profile from below
                         :description "N/A"
                         :main "target/hi.js" ; we target the cljsbuild :main profile from below
                         :repository {:type "git" :url "git+https://github.com/georgewsinger/hi.git"}
                         :keywords ["clojure" "clojurescript" "CLI" "utility"]
                         :author "George Singer"
                         :license "MIT"
                         :private false
                         :homepage "https://github.com/georgewsinger/hi#readme"}}
  ...
  :cljsbuild { :builds { ;; main is the default cljsbuild profile, marked by its use of the :advanced compilation mode
                         ...
                         :test-none {
                           ...
                           :compiler { :optimizations :none
                                       ...
                                       :output-to     "target/hi-test-none.js"
                                       :externs       ["externs.js"]
                                       :verbose       true
                                       :main          hi.runner
                                       :pretty-print  true }}
                         ...
                         :test-advanced {
                           ...
                           :compiler { :optimizations :advanced
                                       ...
                                       :output-to     "target/hi-test-advanced.js"
                                       :externs       ["externs.js"]
                                       :verbose       true
                                       :main          hi.runner
                                       :pretty-print  true }}}})
