(defproject hello4 "0.0.1-SNAPSHOT" ; "SNAPSHOT" is a maven term; it means "development version", and is contrasted with "release"
  ...
  :npm { ;; package.json npm dependencies
         ...
         :package      { :name "hello4"
                         ...
                         :bin "target/hello4.js" ; we target the cljsbuild :main profile from below
                         :description "N/A"
                         :main "target/hello4.js" ; we target the cljsbuild :main profile from below
                         :repository {:type "git" :url "git+https://github.com/georgewsinger/hello4.git"}
                         :keywords ["clojure" "clojurescript" "CLI" "utility"]
                         :author "George Singer"
                         :license "MIT"
                         :private false
                         :homepage "https://github.com/georgewsinger/hello4#readme"}}
  ...
  :cljsbuild { :builds { ;; main is the default cljsbuild profile, marked by its use of the :advanced compilation mode
                         ...
                         :none {
                           ...
                           :compiler { :optimizations :none
                                       :target        :nodejs
                                       :output-dir    "out-none"
                                       :output-to     "target/hello4-none.js"
                                       :externs       ["externs.js"]
                                       :verbose       true
                                       :pretty-print  true }}
                         ...
                         :test-none {
                           ...
                           :compiler { :optimizations :none
                                       ...
                                       :output-to     "target/hello4-test-none.js"
                                       :externs       ["externs.js"]
                                       :verbose       true
                                       :main          hello4.runner
                                       :pretty-print  true }}
                         ...
                         :test-advanced {
                           ...
                           :compiler { :optimizations :advanced
                                       ...
                                       :output-to     "target/hello4-test-advanced.js"
                                       :externs       ["externs.js"]
                                       :verbose       true
                                       :main          hello4.runner
                                       :pretty-print  true }}}})
